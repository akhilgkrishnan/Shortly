...
class UrlTest < ActiveSupport::TestCase
  ...
  test 'should generate slug, after initialization' do
    assert_not_nil @url.slug
  end

  test 'count the number of urls' do
    assert_difference ['Url.count'] do
      Url.create(long_url: 'https://google.com', short_url: 'https://sample.com/test')
    end
  end
  ...
  test 'should not create multiple entry with same long url' do
    Url.create(long_url: 'https://facebook.com', short_url: 'https://sample.com/test1')
    Url.create(long_url: 'https://facebook.com', short_url: 'https://sample.com/test2')
